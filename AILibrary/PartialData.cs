...
namespace AILibrary
{
    ...
    public class PartialData : Item
    {
        ...
        public PartialData(int itemID, string name, Sprite itemSprite, string itemDescription = "", bool isGet = false, bool isImported = false)
