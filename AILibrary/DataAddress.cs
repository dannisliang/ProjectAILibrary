...
namespace AILibrary
{
    ...
    public class DataAddress : Item
    {
        ...
        public DataAddress(int itemID, string name, Sprite itemSprite, string itemDescription = "", bool isGet = false, bool isImported = false)
